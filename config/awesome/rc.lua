...
-- Prevent blurry icons (like Firefox)
...
-- "gears.filesystem.get_themes_dir().." for relative path 
...
-- insert after beautiful.init("...") Pomodoro timer
...
globalkeys = gears.table.join(
   awful.key({ "Mod1" }, "Shift_L", function () toggle_keyboard_layout() end, 
    ...
    -- PrintScreen (Flameshot), doesn't need a .desktop btw 
    awful.key({}, "Print", function() awful.util.spawn("flameshot gui",false) end,
              { description = "PrintScreen with Flameshot", group = "launcher"}),
